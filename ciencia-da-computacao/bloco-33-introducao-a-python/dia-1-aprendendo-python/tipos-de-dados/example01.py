# LISTAS (list)
# Uma lista é uma sequência mutável e ordenada de elementos. Ela pode armazenar elementos heterogêneos,
# ter seu tamanho variável e crescer à medida que itens são adicionados.
